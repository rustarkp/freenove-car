...
## Notes
- The current Freenove code already includes a client/server pattern that can be extended for streaming and remote control.
- The next milestone should be a simple, low-latency video stream plus a basic gamepad-driven movement mode.
